...
// I ended up just making cycle 'async' which I know doesn't use Hardware level threads, but it males 'cycle' a nonblocking call that I guess is one step better than nothing at all
